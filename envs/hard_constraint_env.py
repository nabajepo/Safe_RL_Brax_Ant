...
from envs.baseline_env import BraxAntBase, register_env
...
class BraxAntHardConstraint(BraxAntBase):
    ...
    def step(self, action):
        ...
        reward = 5.0 * progress - self.cfg.step_penalty
        ...
        reward = reward - speed_violation * self.cfg.speed_penalty * 2.0 # increase speed violation penalty, but do not terminate immediately
        ...
        reward += np.exp(-dist_after) * 3.5 #dense goal shaping
