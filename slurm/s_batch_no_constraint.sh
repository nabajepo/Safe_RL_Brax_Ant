...
#SBATCH --job-name=no_constraint_pipeline
#SBATCH --output=no_constraint_pipeline_%j.txt
#SBATCH --error=no_constraint_pipeline_%j.txt
...
FINAL_EVAL_EPS=200
ROLLOUTS_PER_SEED=3
CHECKPOINT_EVERY_TIMESTEPS=5000000
...
echo "============================================================"
echo "Submitting pipeline for model: ${MODEL_NAME}"
...
#SBATCH --mem=64G
#SBATCH --gres=gpu:1
#SBATCH --exclude=ng11105,ng11106
#SBATCH --mail-user=engou005@uottawa.ca
